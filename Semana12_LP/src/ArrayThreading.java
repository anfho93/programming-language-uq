...
/* 
 * This is a thread example launches multiple threa
ds to 
...
class ArrayThreading  { 
    ...
    /*** 
     ...
     $ java ArrayThreading 100000000    ## 100M too bi
g 
        Exception in thread "main" java.lang.OutOfM
emoryError: Java heap space 
        at ArrayThreading.<init>(ArrayThreading.jav
a:16) 
        at ArrayThreading.main(ArrayThreading.java:
92) 
     $ java -Xmx500m ArrayThreading 100000000  ## s
pecify 500M memory -- fine 
